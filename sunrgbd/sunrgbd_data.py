...
class sunrgbd_object(object):
    ...
    def __init__(self, root_dir, split='training', use_v1=False):
        ...
        # self.split_dir = "/home/harshit/meta/3detr/sunrgbd/sunrgbd_trainval/"
    ...
    def get_label_objects(self, idx):
        ...
        # label_filename = os.path.join("/home/harshit/meta/3detr/sunrgbd/sunrgbd_trainval/label_v1/", '%06d.txt'%(idx))
